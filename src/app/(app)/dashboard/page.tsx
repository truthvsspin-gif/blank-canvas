        ...
        actions={
          <div className="flex flex-wrap gap-2">
            <Button className="bg-rose-600 text-white hover:bg-rose-500" asChild>
              <Link href="/crm/bookings/new">{text.actions.newAppt}</Link>
            </Button>
            <Button variant="outline" className="border-slate-200" asChild>
              <Link href="/crm/customers/new">{text.actions.newClient}</Link>
            </Button>
            <Button variant="outline" className="border-slate-200" asChild>
              <Link href="/crm/customers">{text.actions.viewClients}</Link>
            </Button>
          </div>
        }
      />
        ...
        <Card className="border-slate-200 bg-white">
          <CardHeader className="flex flex-row items-center justify-between">
            ...
            <Button size="sm" variant="outline" asChild>
              <Link href="/crm/bookings" className="flex items-center">
        ...
        <Card className="border-slate-200 bg-white">
          <CardHeader className="flex flex-row items-start justify-between">
            ...
            <Button size="icon" variant="ghost" asChild>
              <Link href="/crm/services" aria-label="View services">
        ...
        <CardHeader className="flex flex-row items-center justify-between">
          ...
          <div className="flex flex-wrap items-center gap-2">
            <Button size="sm" variant="outline" className="border-slate-200" asChild>
              <Link href="/crm/bookings">{text.viewAllBookings}</Link>
            </Button>
            <Button size="sm" variant="outline" className="border-slate-200" asChild>
              <Link href="/crm/bookings/new" className="flex items-center gap-2">
