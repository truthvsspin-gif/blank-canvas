...
const followUpTemplates = {
  es: {
    "24h": () =>
      "Hola, solo quería confirmar si el enfoque que te recomendé se ajusta a lo que buscas para tu vehículo. Si quieres, podemos revisar disponibilidad.",
    "5d": () =>
      "Se abrió un espacio esta semana para este tipo de servicio. Avísame si te gustaría avanzar.",
  },
  en: {
    "24h": () =>
